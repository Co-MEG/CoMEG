...
MIN_SUPPORT = 8
MAX_SUPPORT = 1000
DATASETS = ['wikivitals', 'wikivitals-fr', 'wikischools'] #['lastfm']

if __name__=='__main__':

    for dataset in DATASETS:
        dataset2json(dataset, f'data/graph_{dataset}_max_support_{MAX_SUPPORT}_min_support_{MIN_SUPPORT}.json', min_support=MIN_SUPPORT, max_support=MAX_SUPPORT)
